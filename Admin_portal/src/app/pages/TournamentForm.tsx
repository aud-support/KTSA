            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <input
                    ref={(el) => { if (el) (el as any)._isStart = true; }}
                  ...
                  <button
                    type="button"
                    onClick={() => {
                      const el = document.getElementById("startDateTimeInput") as HTMLInputElement | null;
                      if (el) {
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <button
                    type="button"
                    onClick={() => {
                      const el = document.getElementById("endDateTimeInput") as HTMLInputElement | null;
                      if (el) {
                        try { el.showPicker(); } catch { el.focus(); }
                      }
                    }}
