        ...
        if (json.success && json.data) {
          const mapped: Tournament[] = json.data.map((t: any) => ({
            ...
            enabledCategories: [
              ...
              t.underSixteenEnabled        && "Junior U16 Singles",
              t.aboveSixteenEnabled        && "Above 16",
              t.juniorAbove16SingleEnabled && "Junior Above 16 Singles",
              t.disabledSingleEnabled      && "Disabled Singles",
              t.openDoubleEnabled          && "Open Doubles",
              t.mixedDoubleEnabled         && "Mixed Doubles",
              t.beginnerDoubleEnabled      && "Beginner Doubles",
              t.womensDoubleEnabled        && "Women's Doubles",
              t.mensDoubleEnabled          && "Men's Doubles",
              t.juniorU16DoubleEnabled     && "Junior U16 Doubles",
              t.juniorAbove16DoubleEnabled && "Junior Above 16 Doubles",
              t.seniorDoubleEnabled        && "Senior Doubles",
              t.disabledDoubleEnabled      && "Disabled Doubles",
              t.disabledMixedEnabled       && "Disabled Mixed",
              t.monsterDypEnabled          && "Monster - DYP",
              t.teamEventEnabled           && "Team Event",
            ].filter(Boolean) as string[],
            categoryFees: {
              "Open Singles":            t.openSingleFee          ?? null,
              "Women's Singles":         t.womenSingleFee         ?? null,
              "Men's Singles":           t.mensSingleFee          ?? null,
              "Junior U16 Singles":      t.underSixteenFee        ?? null,
              "Above 16":                t.aboveSixteenFee        ?? null,
              "Junior Above 16 Singles": t.juniorAbove16SingleFee ?? null,
              "Disabled Singles":        t.disabledSingleFee      ?? null,
              "Open Doubles":            t.openDoubleFee          ?? null,
              "Mixed Doubles":           t.mixedDoubleFee         ?? null,
              "Beginner Doubles":        t.beginnerDoubleFee      ?? null,
              "Women's Doubles":         t.womensDoubleFee        ?? null,
              "Men's Doubles":           t.mensDoubleFee          ?? null,
              "Junior U16 Doubles":      t.juniorU16DoubleFee     ?? null,
              "Junior Above 16 Doubles": t.juniorAbove16DoubleFee ?? null,
              "Senior Doubles":          t.seniorDoubleFee        ?? null,
              "Disabled Doubles":        t.disabledDoubleFee      ?? null,
              "Disabled Mixed":          t.disabledMixedFee       ?? null,
              "Monster - DYP":           t.monsterDypFee          ?? null,
              "Team Event":              t.teamEventFee           ?? null,
            },
